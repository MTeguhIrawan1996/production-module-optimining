...
import CreateMapYearlyProductionBook from './sections/CreateMapYearlyProductionBook';

const CreateMapYearlyProductionPage = () => {
...
export default CreateMapYearlyProductionPage;
