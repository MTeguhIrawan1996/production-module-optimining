...
import CreateMapQuarterlyProductionBook from './sections/CreateMapQuarterlyProductionBook';

const CreateMapQuarterlyProductionPage = () => {
      ...
      >
        <Tabs defaultValue="information" radius={4}>
          ...
          <Tabs.Panel value="information">
            <CreateMapQuarterlyProductionBook />
          </Tabs.Panel>
        </Tabs>
      </InnerWrapper>
    </RootWrapper>
...
export default CreateMapQuarterlyProductionPage;
