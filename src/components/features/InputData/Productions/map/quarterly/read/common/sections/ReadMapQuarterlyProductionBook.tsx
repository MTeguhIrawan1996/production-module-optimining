...
const ReadMapQuarterlyProductionBook = () => {
  ...
  return (
    <DashboardCard
      ...
      enebleBackBottomOuter={{
        onClick: () =>
          router.push('/input-data/production/map/quarterly?tabs=quarterly'),
      }}
      shadow="xs"
          ...
          <Stack spacing="sm" mt="sm">
            ...
            <KeyValueList
              data={[
                ...
                {
                  dataKey: t('commonTypography.quarterly'),
                  value: mapData?.quarter,
                },
              ]}
              type="grid"
            />
...
export default ReadMapQuarterlyProductionBook;
