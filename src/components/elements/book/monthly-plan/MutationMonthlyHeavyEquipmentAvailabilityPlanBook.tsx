...
import {
  IMutationMonthlyHeavyEquipmentAvailabilityPlanValues,
  useCreateMonthlyHeavyEquipmentAvailabilityPlan,
} from '@/services/graphql/mutation/plan/monthly/useCreateMonthlyHeavyEquipmentAvailabilityPlan';
...
const MutationMonthlyHeavyEquipmentAvailabilityPlanBook = ({
  mutationType,
  ...
  const methods = useForm<IMutationMonthlyHeavyEquipmentAvailabilityPlanValues>(
    {
    ...
    useCreateMonthlyHeavyEquipmentAvailabilityPlan({
      ...
      onError: (error) => {
        if (error.graphQLErrors) {
          const errorArry =
            errorBadRequestField<IMutationMonthlyHeavyEquipmentAvailabilityPlanValues>(
              error
            );
          if (errorArry.length) {
...
export default MutationMonthlyHeavyEquipmentAvailabilityPlanBook;
