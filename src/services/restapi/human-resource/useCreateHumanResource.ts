...
type ICreateHumanResourceValuesOmit = Omit<
...
export const useCreateHumanResource = ({
  ...
  onError?: (
    error: AxiosRestErrorResponse<ICreateHumanResourceValuesOmit>
  ) => unknown;
}) => {
  return useMutation<
    ICreateHumanResourceResponse,
    AxiosRestErrorResponse<ICreateHumanResourceValuesOmit>,
    INameValue[]
  >({
